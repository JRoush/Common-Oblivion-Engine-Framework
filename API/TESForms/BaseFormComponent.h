...
public:
    ...
    // members
    //void**                vtbl            // 00
    UInt8                   containerType;    // 04 - container flags?
    UInt8                   typePad[3];        // 05
...
public: 
    ...
    IMPORT /*00C/00C*/ virtual bool         CompareComponentTo(const BaseFormComponent& compareTo) const;
    #ifndef OBLIVION
    INLINE /*---/010*/ virtual void         BuildComponentFormRefList(BSSimpleList<TESForm*>* formRefs);
    INLINE /*---/014*/ virtual void         RemoveComponentFormRef(TESForm& referencedForm);
    INLINE /*---/018*/ virtual bool         ComponentFormRefRevisionsMatch(BSSimpleList<TESForm*>* checkinList);
    INLINE /*---/01C*/ virtual void         GetRevisionUnmatchedComponentFormRefs(BSSimpleList<TESForm*>* checkinList, BSStringT& output);
    INLINE /*---/020*/ virtual bool         ComponentDlgMsgCallback(HWND dialog, UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& result);                  
    IMPORT /*---/024*/ virtual bool         IsComponentDlgValid(HWND dialog);
    IMPORT /*---/028*/ virtual void         SetComponentInDlg(HWND dialog);
    IMPORT /*---/02C*/ virtual void         GetComponentFromDlg(HWND dialog);
    #endif
    ...
    // NOTE: there is no LoadComponent for this method; it is completely integrated into the LoadForm method of it's assorted descendents
